...
#### Modern Minecraft Decompiler (Gradle Based) is a small Gradle buildscript that decompile minecraft for making modded clients for minecraft and researching it's code.
